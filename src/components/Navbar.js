...
import { ReactDOM, React, ReactEventHandler } from 'react'
...
<nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a className="flex items-center"> 
    <a  className="flex items-center"> 
        <img src="https://i.ibb.co/DfbV0Nq/bandw-logo-symbol.png" className="h-8 mr-3" alt="JFMoto-logo" />
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">JFMoto</span>
   </a>
   </a>

  <div className="flex md:order-2">
      <button type="button" onClick={handleClick} className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Pokračovať na E-Shop</button>
